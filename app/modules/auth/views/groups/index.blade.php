...
@section('title_description')
    @if(Sentry::getUser()->hasAccess('groups-create-form'))
    <a href="{{ URL::route('groups-create-form') }}" class="btn btn-primary"><span class="glyphicon glyphicon-plus-sign"></span> New Groups</a>
    @endif
@stop
@section('css')
            ...
            <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                    <div class="categories-controls margin">
                        @if(Sentry::getUser()->hasAccess('groups-delete'))
                        <!-- Check all button -->
                            ...
                            @foreach($groups as $key => $value)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(Sentry::getUser()->hasAccess('groups-edit-form'))
                                            <a class="btn btn-small btn-info" href="{{ URL::route('groups-edit-form', $value->id) }}">Edit </a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
        ...
        $(function () {
            ...
            $('.btn_trash').click(function() {
                ...
                $checked.each(function(index, value) {
                    $.ajax({
                        url: "{{ URL::route('groups-delete', '') }}" + '/' + $(value).val(),
                        method: 'DELETE',
                        async: false
                    });
                    if ($counter == (index+1)) {
